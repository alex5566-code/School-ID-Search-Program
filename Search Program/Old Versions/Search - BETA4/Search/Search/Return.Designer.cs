namespace csvToGrid
{
	partial class Return
	{
		...
		private void InitializeComponent()
		{
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(223, 142);
			...
			this.button3.Text = "Search received records";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(136, 182);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(115, 34);
			this.button4.TabIndex = 35;
			this.button4.Text = "Search returned records";
			...
			this.button5.Text = "Search unordered records";
			this.button5.UseVisualStyleBackColor = true;

			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(187, 222);
			...
			this.button2.Text = "Receive products";
