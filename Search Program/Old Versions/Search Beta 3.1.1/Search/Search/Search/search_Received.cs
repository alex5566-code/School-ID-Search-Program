...
namespace csvToGrid
	{
        ...
        {
            // TODO: This line of code loads data into the 'StudentsDataSet.script_Orders' table. You can move, or remove it, as needed.
            this.script_OrdersTableAdapter.Fill(this.StudentsDataSet.script_Orders);
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
			...
			try
			{
				...
				if (result == DialogResult.Yes)
				{
					...
					this.script_OrdersTableAdapter.Update(this.StudentsDataSet.script_Orders);
