namespace csvToGrid
{
	partial class Receive
	{
		...
		private void InitializeComponent()
		{
			...
			this.button3.Text = "Returm Products";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(195, 215);
			...
			this.button2.Text = "Search received records";
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(252, 175);
